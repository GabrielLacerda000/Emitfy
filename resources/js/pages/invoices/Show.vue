                ...
                <div class="mt-6 grid gap-6 md:grid-cols-2">
                    ...
                    <Card class="p-6">
                        ...
                        <dl class="space-y-3 text-sm">
                            <div>
                                <dt class="font-medium text-muted-foreground">Issue Date</dt>
                                <dd class="mt-1">{{ formatDate(invoice.issue_date) }}</dd>
                            </div>
                            <div>
                            ...
                            <div v-if="invoice.sent_at">
                                <dt class="font-medium text-muted-foreground">Sent On</dt>
                                <dd class="mt-1">{{ formatDate(invoice.sent_at) }}</dd>
                            </div>
                            <div v-if="invoice.paid_at">
                                <dt class="font-medium text-muted-foreground">Paid On</dt>
                                <dd class="mt-1">{{ formatDate(invoice.paid_at) }}</dd>
                            </div>
                        </dl>
                    </Card>
                    ...
                    <Card class="p-6">
                        ...
                        <dl class="space-y-3 text-sm">
                            ...
                            <div v-if="invoice.client.company_name">
                                ...
                                <dd class="mt-1">{{ invoice.client.company_name }}</dd>
                            </div>
                        </dl>
                    </Card>
                </div>
